 local MultiSensorConcatenation = torch.class('rltorch.MultiSensorConcatenation','rltorch.Sensor'); 

 -- A sensor that returns a concatenation of the observation of multiple sensors (as a 1xn vector)
function MultiSensorConcatenation:__init(world,sensors)
...
function MultiSensorConcatenation:observe(world)  
 local retour 
